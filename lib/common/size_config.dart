...
class SizeConfig {
  ...
  void init(BoxConstraints constraints, Orientation orientation) {
    ...
    print('screen_width ' + _screenWidth.toString());
    print('screen_height ' + _screenHeight.toString());
    ...
    height_0_3_5 = heightMultiplier * 0.35;
    height_0_4 = heightMultiplier * 0.4;
    ...
    height_12_5 = heightMultiplier * 12.5;
